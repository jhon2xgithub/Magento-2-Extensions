...
namespace Braem\Members\Model\ResourceModel\Eav;
...
{
    const MODULE_NAME = 'Braem_Members';

    const ENTITY = 'braem_members_eav_attribute';
     ...
     * @var string
     */
    protected $_eventPrefix = 'braem_members_entity_attribute';
...
//    {
//        parent::_construct();
//        $this->_init('Braem\Members\Model\ResourceModel\Eav\Attribute');
//    }
