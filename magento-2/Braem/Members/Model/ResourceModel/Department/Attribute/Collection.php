 ...
 */
namespace Braem\Members\Model\ResourceModel\Department\Attribute;
...
class Collection extends \Magento\Eav\Model\ResourceModel\Entity\Attribute\Collection
{
    ...
    {
        $this->_init(
            'Braem\Members\Model\ResourceModel\Eav\Attribute',
    ...
    protected function _initSelect()
    {
        $entityTypeId = (int)$this->_eavEntityFactory->create()->setType(
            \Braem\Members\Model\Department::ENTITY
        )->getTypeId();
        ...
        $this->getSelect()->from(array('main_table' => $this->getResource()->getMainTable()))
            ...
            ->join(
                array('additional_table' => $this->getTable('braem_members_eav_attribute')),
