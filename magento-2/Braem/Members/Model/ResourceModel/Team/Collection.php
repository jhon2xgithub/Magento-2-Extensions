<?php
namespace Braem\Members\Model\ResourceModel\Team;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Collection\AbstractCollection
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'braem_members_team_collection';
     ...
     * @var string
     */
    protected $_eventObject = 'team_collection';
    ...
    {
        $this->_init('Braem\Members\Model\Team', 'Braem\Members\Model\ResourceModel\Team');
        //$this->_initTables();
    }
...
//    {
//        $this->_memberWebsiteTable = $this->getResource()->getTable('catalog_product_website');
