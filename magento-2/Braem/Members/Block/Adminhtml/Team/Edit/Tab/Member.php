...
class Member extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        if ($this->getTeam()->getId()) {
            $constraint = 'related.team_id='.$this->getTeam()->getId();
        } else {
            $constraint = 'related.team_id=0';
        }
    ...
    protected function _getSelectedMembers()
    {
        ...
        if (!is_array($members)) {
            $members = $this->getTeam()->getMembersPosition();
    ...
    {
        $selected = $this->getTeam()->getMembersPosition();
    ...
    {
        return $this->_coreRegistry->registry('braem_members_team');
    }
    ...
    {
        return $this->getUrl('braem_members/team/members', ['_current' => true]);
    }
