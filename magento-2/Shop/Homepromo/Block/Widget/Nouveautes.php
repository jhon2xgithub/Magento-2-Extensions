...
class Nouveautes extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
       /**
    ...
    {
        $collection = $this->_objectManager->create('Shop\Homepromo\Model\Nauveautes')->getCollection();
        $ideescadeaux_id = [];
